...
type UserServiceClient interface {
	CheckUserExistence(ctx context.Context, in *User, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error)
}
...
func (c *userServiceClient) CheckUserExistence(ctx context.Context, in *User, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error) {
...
type UserServiceServer interface {
	CheckUserExistence(context.Context, *User) (*wrapperspb.BoolValue, error)
...
func (UnimplementedUserServiceServer) CheckUserExistence(context.Context, *User) (*wrapperspb.BoolValue, error) {
...
func _UserService_CheckUserExistence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CheckUserExistence(ctx, req.(*User))
	}
